const Details = () => {
  return (
    <section className="px-6 mx-auto my-10">
      <button className="border p-2 rounded-md my-8">Go Back Home</button>
      <div className="flex flex-col-reverse lg:flex-row lg:items-center items-start gap-x-10">
        <div className="">
          ...
          <p className="lg:max-w-[90%] leading-6">
            ...
            skills in being able to take in a design and implement it into code.
          </p>
          <p className="my-4">
            <span className="font-semibold">Tech Stack Used:</span> TypeScript,
